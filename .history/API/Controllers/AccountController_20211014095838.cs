...
namespace API.Controllers
{
    public class AccountController : BaseApiController
    {
        ...
        [HttpPost("login")]
        public async Task<ActionResult<AppUser>> login(LoginDto loginDetails) {
            //FindAsync is uselful when trying to find an element through a primary key
            var user = await _context.Users.SingleOrDefaultAsync(x => x.UserName == loginDetails.Username);
